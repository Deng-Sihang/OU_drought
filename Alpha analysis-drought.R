...
write.csv(result,"Allnetwork-LMM-Permutation.csv")

### FDR
data<-read.csv("F:\\1-drought\\All analyses\\UNOISE3-0914-New\\GitHub\\GeoChip-rawdata-2009-2014-Correlation-TN.csv",header = T,row.names = 1)
p <- as.numeric(data[7,]) 
