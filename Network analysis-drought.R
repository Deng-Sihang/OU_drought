...
### Calculate the changes in properties of keystone nodes -------------------
...
### divindex<-read.csv("Env-factor.csv",header = T,row.names = 1)
### It can also be applied for calculating changes in environmental factors
### divindex<-read.csv("GeoChip-rawdata-2009-2014.csv",header = T,row.names = 1)
### divindex<-as.data.frame(t(divindex[,5:52]))
